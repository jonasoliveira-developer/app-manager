  ...
  return (
    <main className="w-full bg-defaultWhite p-5">
      <div className="max-w-7xl m-auto mt-8 text-center py-5">
        ...
        <p className="mt-9 text-xl font-semibold">
        ...
        <div className="w-full flex flex-col items-center justify-center gap-4 md:flex-row">
          {[...Array(3)].map((_, i) => (
            <ul key={i} className="w-full max-w-80 p-5 bg-defaultWhite text-center rounded-3xl">
              ...
              {[...Array(4)].map((_, j) => (
                <li key={j}>Agende seus pacientes com facilidade e envie notificações</li>
              ))}
            </ul>
          ))}
        </div>
      ...
      <footer className="h-[600px] bg-defaultDarkGreen text-white flex flex-col items-center justify-center">
        ...
        <h4>
          Created-by <Link href="https://www.linkedin.com/in/jonasoliveira-desenvolvedor/">Jonas Oliveira</Link>
        </h4>
      </footer>
    </main>
  );
